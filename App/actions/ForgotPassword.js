...
export const UPDATE_FORGOT_MOBILE_NUMBER = "register/UPDATE_FORGOT_MOBILE_NUMBER";
export const ON_FORGOT_OTP_REQUEST_START = "register/ON_FORGOT_OTP_REQUEST_START";
export const ON_FORGOT_OTP_REQUEST_SUCCESS = "register/ON_FORGOT_OTP_REQUEST_SUCCESS";
...
export const UPDATE_SUBMEET_FORGOT_OTP_FORM = "register/UPDATE_SUBMEET_FORGOT_OTP_FORM";
export const UPDATE_SUBMEET_FORGOT_ENTER_PASSWORD = "register/UPDATE_SUBMEET_FORGOT_ENTER_PASSWORD";
export const UPDATE_SUBMEET_FORGOT_REENTER_PASSWORD = "register/UPDATE_SUBMEET_FORGOT_REENTER_PASSWORD";
export const ON_SUBMEET_RESET_PASSWORD_START = "register/ON_SUBMEET_RESET_PASSWORD_START";
...
export const onSubmeetResetPassword = () => (dispatch,getState) => {
  ...
  const {forgotEnetrPassword,forgotReEnetrPassword,userId} = getState().forgot;
